...
# Evaluate all models
models_to_eval = [
    ("ResNet-50 Baseline", "resnet50_dr.pth", load_resnet50),
    ("EfficientNet-B3", "efficientnet_b3_dr.pth", load_efficientnet_b3),
    ("ResNet-50 Weighted", "resnet50_weighted_dr.pth", load_resnet50),
]

results = []

for name, weights, loader_fn in models_to_eval:
    print(f"\nEvaluating {name}...")
